                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _InstructionStep(
                          number: 1,
                          text: tr(context, "Say what’s on your mind", "قل ما يدور في ذهنك"),
                        ),
                        _InstructionStep(
                          number: 2,
                          text: tr(context, "Let The Guider reflect and reframe", "دع المُرشد يعكس ويعيد الصياغة"),
                        ),
                        _InstructionStep(
                          number: 3,
                          text: tr(context, "Notice which inner part shows up", "لاحظ أي جزء داخلي يظهر"),
                        ),
                        _InstructionStep(
                          number: 4,
                          text: tr(context, "Choose a next step with clarity", "اختر الخطوة التالية بوضوح"),
                        ),
                      ],
                    ),
                  ),
