// lib/features/guider/presentation/screens/guider_voice_chat_history_screen.dart
...
class GuiderVoiceChatHistoryScreen extends StatefulWidget {
  final GuiderVoiceSession session;
  final String userName;

  const GuiderVoiceChatHistoryScreen({
    super.key,
  ...
  @override
  State<GuiderVoiceChatHistoryScreen> createState() => _GuiderVoiceChatHistoryScreenState();
}

class _GuiderVoiceChatHistoryScreenState extends State<GuiderVoiceChatHistoryScreen> {
  late final GuiderVoiceSessionRepository _repository;
  List<GuiderVoiceMessage> _messages = [];
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Text(
          tr(
            context,
            'This voice session has ended. You\'re viewing it in read-only mode.',
            'انتهت هذه الجلسة الصوتية. أنت تعرضها الآن في وضع القراءة فقط.',
          ),
