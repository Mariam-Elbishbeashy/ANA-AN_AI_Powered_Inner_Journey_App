...
class VoiceSessionViewerScreen extends StatelessWidget {
  final UserCharacter character;
  final VoiceSession session;

  const VoiceSessionViewerScreen({
    super.key,
  ...
  void _viewChatHistory(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => VoiceChatHistoryScreen(
          character: character,
          session: session,
        ),
      ),
                ...
                child: Container(
                  ...
                  child: Text(
                    tr(
                      ...
                      'انتهت جلسة الصوت هذه. أنت تعرضها الآن في وضع القراءة فقط.',
                    ),
